...
class ManterJogosUI:
    ...
    def listar():
        ...
        if len(jogos) == 0: st.write("Nenhum jogo até o momento")
            ...
            st.dataframe(df, hide_index=True, column_order=["id", "descricao", "idCategoria"])     
    ...
    def inserir():
        ...
        if len(View.categoria_listar()) > 0 and st.button("Inserir"): 
            try:
                View.jogos_inserir(id, descricao, categoria.get_id())
        ...
        if len(jogos) == 0: st.write("Nenhum jogo até o momento")
            ...
            if op:
                if st.button("Excluir"):
                    ...
                    View.produto_excluir(id, descricao, idCategoria)
